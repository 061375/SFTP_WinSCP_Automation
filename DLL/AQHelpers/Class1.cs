...
namespace AQHelpers
{
    public class EmailParams
    {
        ...
        public string EmailCredentialsUser;
        public string EmailCredentialsPass;
    ...
    public class Helpers
    {
        ...
        public void SetIsTesting(bool s) { Testing = s; }
        ...
        public void SetLogMethods(bool s) { LogMethods = s; }
        public void SetEmailParams(EmailParams e)
        {
            emailParams = e;
        }
        public void WriteLog(string line, string path = null, bool datetime = true, string ext = ".log")
        {
            ...
            try
            {
                ...
                path += "/" + ApplicationName + (Testing ? "_TESTING" : "") + "_log" + ext;
        ...
        public void LogMethod(string append = null, bool datetime = true, bool ip = false)
        {
            if (ConsoleLog)
                Console.WriteLine(DateTime.Now.ToString("MM/dd/yyyy h:mm tt") + " LogMethods " + LogMethods.ToString());
            if (LogMethods)
            {
                // Get call stack
                System.Diagnostics.StackTrace stackTrace = new System.Diagnostics.StackTrace();
                WriteLog("Method:: " + stackTrace.GetFrame(1).GetMethod().Name + " " + append, null, datetime);
            }
        }
        public void LogError(string error, string path = null, bool fatal = false)
        {
            if (ConsoleLog)
            ...
            try
            {
                ...
                path += "/" + System.Reflection.Assembly.GetExecutingAssembly().GetName().Name + (Testing ? " TESTING" : "") + "_ERROR.log";
        ...
        public void SendEmail(string to, string subject, string message = "", List<string> attachments = null)
        {
            try
            {
                ...
                SmtpServer.Port = emailParams.EmailPort;
                SmtpServer.Credentials = new System.Net.NetworkCredential(emailParams.EmailCredentialsUser, emailParams.EmailCredentialsPass);
